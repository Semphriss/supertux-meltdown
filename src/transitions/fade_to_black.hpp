...
#ifndef _HEADER_STMELTDOWN_TRANSITIONS_FADETOBLACK_HPP
#define _HEADER_STMELTDOWN_TRANSITIONS_FADETOBLACK_HPP

#include "transitions/transition.hpp"

class FadeToBlack final :
  public Transition
{
public:
  FadeToBlack(Scene* from, Scene* to, float time);
  virtual ~FadeToBlack() override = default;
