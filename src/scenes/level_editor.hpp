...
#ifndef _HEADER_STMELTDOWN_SCENES_LEVELEDITOR_HPP
#define _HEADER_STMELTDOWN_SCENES_LEVELEDITOR_HPP
...
public:
  LevelEditor() = delete;
  LevelEditor(IGameManager& game_manager);
...
private:
  Vector sp_to_tp(const Vector& screen_point, const TileMap& tilemap) const;

private:
  std::unique_ptr<GameObjectManager> m_sector;
  TileMap* m_current_tilemap;
